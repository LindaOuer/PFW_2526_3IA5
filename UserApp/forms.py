...
class RegisterForm(UserCreationForm):
    ...
    affiliation = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Votre affiliation"}
        ),
    )
    nationality = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Votre nationalité"}
        ),
    )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "password2": forms.PasswordInput(
                attrs={"class": "form-control", "placeholder": "Confirmez"}
            ),
        }
        labels = {
